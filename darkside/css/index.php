...
if ($color)
{
	...
	$bootstrap = str_replace('var(--bs-body-color-rgb)', '222,222,222', $bootstrap);
	$bootstrap = str_replace('var(--bs-body-bg-rgb)', '22,22,22', $bootstrap);
...
.nav-link.active{border-color:#ccc #ccc var(--bs-dark) #ccc!important}
