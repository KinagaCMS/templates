...
echo $bootstrap, $n,
file_get_contents('jquery.fancybox.min.css'), $n,
file_get_contents('simple-sidebar.css'), $n,
'#page-top{bottom:1em;position:fixed;right:2em;display:none;z-index:10;clear:both}
