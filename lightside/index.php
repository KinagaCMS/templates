...
'<img class=my-3 src="'. $url. 'images/icon.php" alt=logo width=250 height=200><span class="d-block h1">'. $site_name. '</span>' :
get_logo(true,'d-block h1', 250)?>
</a>
</div>
<?=!$use_search ? '' :
'<div class="d-block p-4 border-bottom">'. $search. '</div>',
!$nav ? '' :
