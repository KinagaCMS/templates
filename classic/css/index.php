...
@media(max-width:991px){input[type="search"]{margin-top:1em}#form .input-group-text{display:block}}@media(max-width:767px){.index{flex-direction:column}.index div{width:100%!important}}';
...
|| is_file($header_img = '../../../images/header.png') || is_file($header_img = 'header.png'))
{
	...
	echo'
body:before{background-image:url('. $header_img. ');background-position:bottom;background-repeat:no-repeat;background-size:cover;content:"";display:block;filter:brightness(.7);height:'. $height. 'px;width:100%}
